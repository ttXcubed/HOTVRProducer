...
from PhysicsTools.NanoAOD.jetsHOTVR_cff import *
...
nanoTableTaskCommon = cms.Task(
    ...
    jetPuppiTask, jetPuppiForMETTask, jetAK8Task, jetHOTVRTask,
    ...
    jetPuppiTablesTask, jetAK8TablesTask, jetHOTVRTablesTask,

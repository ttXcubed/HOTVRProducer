...
# with command line options: NANO -s NANO --data --era Run3,run3_nanoAOD_124 --conditions 124X_dataRun3_PromptAnalysis_v1 --eventcontent NANOAODSIM --datatier NANOAODSIM --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT= cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 --no_exec -n 10
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov///store/data/Run2022E/EGamma/MINIAOD/PromptReco-v1/000/359/137/00000/81b00ac8-59cd-456b-baf7-63542bd75603.root'),
